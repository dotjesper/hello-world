...
| **[invoke-helloworld-v1.ps1](./scripts/invoke-helloworld-v1.ps1)** | Hello World v1 - demonstration script with intentional errors and misconfigurations for learning and review exercises. |
| **[Invoke-HelloWorld.v2.ps1](./scripts/Invoke-HelloWorld.v2.ps1)** | Hello World v2 - demonstration script showcasing PowerShell invocation details and 64-bit relaunch. |
...
| **[New-VMHydration.ps1](./scripts/New-VMHydration.ps1)** | Virtual machine hydration script for provisioning and configuring VMs. |
...
This section tracks notable changes to the scripts in this repository. For a complete history of all changes, please refer to the [Revision](https://github.com/dotjesper/hello-world/wiki/Revision) in the project wiki.

#### May 18, 2026

- Added Invoke-HelloWorld.v1.ps1 v1.0.0 - repurposed as a learning and review exercise with intentional errors
- Renamed Invoke-HelloWorld.ps1 to invoke-helloworld-v2.ps1 - demonstration script showcasing PowerShell invocation details and 64-bit relaunch

#### April 9, 2026

- Added New-VMHydration.ps1 v1.0.0 - creates and configures Hyper-V virtual machines from a template or blank disk
